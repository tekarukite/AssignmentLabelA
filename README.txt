...
- This is only the Backend of the project, so we don't have templates.
...
4. Activate the server with django ("python manage.py runserver")

To test the functionalities it is advisable to use POSTMAN.
